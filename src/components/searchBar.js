...
const SearchBar = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const restUrl = `/api/lyrics/ws/1.1/track.search?${selectParam}=${paramToSearch}&page_size=4&page=6&page_size=6&f_has_lyrics=1&s_track_rating=desc&apikey=${musicMatch}`;
    setIsLoading(true);
